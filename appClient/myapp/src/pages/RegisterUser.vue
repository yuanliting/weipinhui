...
<template>
    <div>
        ...
        <p class="input1">
            手机号&#x3000;
            <input class="phone"  type="text" name="phone" v-model="phone" id="phone" placeholder="请输入手机号">
        </p>
        <p class="verify">
            验证码&#x3000;
            <input class="verified"  type="password" id="code" name="verify" placeholder="请输入验证码"  v-model="code">
        ...
        <button class="btn" @click="query">手机号注册</button>
        <p class="statement">
